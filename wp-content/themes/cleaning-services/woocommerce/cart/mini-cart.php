...
<div class="prd-sm">
	...
	<?php else : ?>
		...
		<div class="empty"><?php _e( 'No products in the cart.', 'cleaning-services' ); ?></div>
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="total"><strong><?php _e( 'Total', 'cleaning-services' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
