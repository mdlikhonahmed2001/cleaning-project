...
vc_map(array(
    "name" => esc_html__("Cleaning Gallary", 'cleaning_services'),
    "base" => "gallaries",
    "class" => "",
    ...
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => esc_html__("Number of Gallary", 'cleaning_services'),
            "param_name" => "showposts",
            "value" => "10",
            "description" => esc_html__('Set how many gallary image will display.', 'cleaning_services'),
            "admin_label" => true,
        ),
        array(
            'type' => 'dropdown',
            'heading' => esc_html__('Order By', 'cleaning_services'),
            'param_name' => 'orderby',
            'value' => array(
                'Date' => 'date',
                'ID' => 'ID',
            ...
            'description' => esc_html__('Select order type.', 'cleaning_services'),
            "admin_label" => true,
        ),
        array(
            'type' => 'dropdown',
            'heading' => esc_html__('Sort Order', 'cleaning_services'),
            'param_name' => 'order',
            'value' => array('Descending' => 'DESC', 'Ascending' => 'ASC'),
            'description' => esc_html__('Select sorting order.', 'cleaning_services'),
            "admin_label" => true,
        ),
        array(
            "type" => "dropdown",
