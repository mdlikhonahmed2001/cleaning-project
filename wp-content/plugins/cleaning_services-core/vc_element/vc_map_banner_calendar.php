...
vc_map(array(
    ...
    "params" => array(
        array(
            ...
            "holder" => "div",
            "class" => "",
            "heading" => esc_html__("Picture Of Cover Front", 'cleaning_services'),
        ...
        array(
            ...
            "holder" => "div",
            "class" => "",
            "heading" => esc_html__("Picture Of Cover Back", 'cleaning_services'),
        ...
        array(
            ...
            "holder" => "div",
            "class" => "",
            "heading" => esc_html__("Picture Of Calendar Img", 'cleaning_services'),
        ...
        array(
            'type' => 'textarea_html',
            'heading' => esc_html__('Banner Paragraph ', 'cleaning_services'),
            'param_name' => 'content',
            'value' => ''
        ),
        array(
            "type" => "textfield",
            "admin_label" => false,
            "heading" => esc_html__("Action Button Title", 'cleaning_services'),
